...
feature_len=64
num_clusters=4
total_vertices=1889971 #1890931
        ...
        #for gamma_point_1 in gamma_point_1_arr:
            for edge_percent in edge_percent_arr:
                for iter_iterval in iter_iterval_arr:
                    ...
                    vertices = pkl.load(open("SW-620H_4_clusters.p", "rb"))
                    ...
                    dir_name="GAT_first_layer_Aggregation_SW-620H_"+"_"+"num_machines"+str(num_clusters)
                    ...
                    for iter in range(normal_iter_num):
                        ...
                        for k in range(num_mach):
                            PE_cycles_required=leaky_relu_cycles+exponential_cycles+2*math.ceil(num_egdes_processed_list[k]/num_edge_processed_per_memory_access)*2
                            computation_cycle_list_per_machine_per_iter.append(PE_cycles_required) ## 2 since we assume 4 MAC unit and process 8 elements per PE
