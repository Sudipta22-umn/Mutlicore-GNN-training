        ...
        #for gamma_point_1 in gamma_point_1_arr:
            for edge_percent in edge_percent_arr:
                for iter_iterval in iter_iterval_arr:
                    ...
                    vertices = pkl.load(open("DD_singe_cluster_ORDERED_METIS.p", "rb"))
                    ...
                    dir_name="GINConv_Aggregation_DD_"+"_"+"num_machines"+str(num_clusters)
